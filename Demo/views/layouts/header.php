...
<head>
    ...
    <style>
        ...
        /* Badges */
        .badge-brand { position: absolute; top: 10px; right: 10px; background: rgba(0,0,0,0.7); color: white; padding: 5px 10px; border-radius: 20px; font-size: 0.8rem; }
        ...
        /* Footer */
        footer { background: #212529; color: #ccc; padding: 40px 0; }
    </style>
</head>
<body>
